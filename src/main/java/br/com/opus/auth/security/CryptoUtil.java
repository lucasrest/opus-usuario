...
import br.com.opus.auth.config.properties.CryptographyProperties;
import br.com.opus.auth.exception.CryptographyException;
import br.com.opus.auth.exception.InvalidPasswordException;
...
public class CryptoUtil {
    ...
    public static void main(String[] args) {
        String senha = new BCryptPasswordEncoder(12).encode("campanha_secr3t3!");
