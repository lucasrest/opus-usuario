package br.com.opus.auth.logger;
...
public enum LoggerStepEnum {
    ...
    OPE00001("[OperacaoController] - [buscartodos]"),
    OPE00002("[OperacaoController] - [buscaPorId]"),
    OPE00003("[OperacaoController] - [incluir]"),
    OPE00004("[OperacaoController] - [atualizar]"),
    OPE00005("[OperacaoController] - [deletar]"),
